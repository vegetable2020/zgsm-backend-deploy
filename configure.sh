...
#---------------------------------------------------------
# 模型服务器的IP，需要根据实际情况设置
MODEL_SERVER_IP="192.168.205.142"
# 对话模型的BASEURL,DEFAULT_MODEL,MODEL_CONTEXTSIZE,APIKEY，初始化后更新配置需在higress中修改
CHAT_MODEL_HOST="${MODEL_SERVER_IP}:11434"
CHAT_BASEURL="http://${CHAT_MODEL_HOST}"
CHAT_DEFAULT_MODEL="deepseek-r1:32b"
CHAT_MODEL_DESC="ollama提供的deepseek-r1:32b"
CHAT_MODEL_CONTEXTSIZE=128000
CHAT_APIKEY=""

# Codereview模型的BASEURL,MODEL,MODEL_CONTEXTSIZE,APIKEY，初始化后更新配置需在higress中修改
CODEREVIEW_MODEL_HOST="${MODEL_SERVER_IP}:11434"
CODEREVIEW_BASEURL="http://${CODEREVIEW_MODEL_HOST}"
CODEREVIEW_MODEL="deepseek-r1:32b"
CODEREVIEW_MODEL_DESC="ollama提供的deepseek-r1:32b"
CODEREVIEW_MODEL_CONTEXTSIZE=262144
CODEREVIEW_APIKEY=""

# 代码补全模型的BASEURL,MODEL,APIKEY
COMPLETION_BASEURL="http://${MODEL_SERVER_IP}:11434/v1/completions"
COMPLETION_MODEL="deepseek-v3.1:671b-cloud"
COMPLETION_APIKEY=""

# 向量嵌入模型的BASEURL,MODEL和APIKEY
EMBEDDER_BASEURL="http://${MODEL_SERVER_IP}:11434/v1/embeddings"
EMBEDDER_MODEL="nomic-embed-text:latest"
EMBEDDER_APIKEY=""

# RAG排序模型的BASEURL,MODEL和APIKEY
RERANKER_BASEURL="http://192.168.133.47:2335/rerank"
...
COSTRICT_BACKEND="192.168.133.47"
