...
#---------------------------------------------------------
# 模型服务器的IP，需要根据实际情况设置
MODEL_SERVER_IP="192.168.133.47"
# 对话模型的BASEURL,DEFAULT_MODEL,MODEL_CONTEXTSIZE,APIKEY，初始化后更新配置需在higress中修改
CHAT_MODEL_HOST="${MODEL_SERVER_IP}:11434"
# 云模型服务的BASEURL
MODEL_SERVER_CLOUD_BASE_URL="https://open.bigmodel.cn/api/coding/paas/v4"

CHAT_BASEURL="${MODEL_SERVER_CLOUD_BASE_URL}"
...
COMPLETION_BASEURL="${MODEL_SERVER_CLOUD_BASE_URL}"
COMPLETION_MODEL="codegeex-4"
COMPLETION_APIKEY="da1d60eb92184e45b620d618b89cb8f0.rraRgoEeKBdHSugR"
